...
const TimeLine =()=>{
    ...
    const submitHandler = async(e)=>{
        e.preventDefault();
        await dispatch(addTimeline(title, description,date));// so that it'll peform then after getUser() will called
        dispatch(getUser());
    };

    const deleteHandler =async(id)=>{
        await dispatch(deleteTimeline(id)); // so that it'll peform then after getUser() will called
        dispatch(getUser());
    };
